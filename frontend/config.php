...
define('G5_DB_CHARSET', 'utf8mb4'); //20230307 CONUT
...
if (isset($g5_path['path'])) {
    ...
    //define('G5_PATH', '');
	define('G5_PATH', '/index.php'); //20230307 CONUT 기본경로 변경
}
*/
...
//CONUT 230313
define('G5_APP_LOBBY',     G5_URL.'/lobby.php');
define('G5_APP_URL',     G5_URL);
define('G5_APP_PATH',     G5_PATH);
define('G5_APP_CDN_IMG', G5_URL.'/edu_img');
...
define('G5_DISPLAY_SQL_ERROR', true); //CONUT 230306 
...
// APP 시스템 알림
define('COQUIZ_APP_ALERT', 0);

// 시즌 대기
define('COQUIZ_SEASON_OFF', 'N');

// 시즌 대기
define('COQUIZ_SEASON_OFF_MSG', '새 시즌 준비중 - 22시 30분 오픈\n\n코퀴즈 시즌은 매 주 새로 시작되고요.\n점수는 리셋, 나머지 재화는 그대로 유지돼요.');

//css js 버전
define('G5_CSS_VER', '241119_2');
define('G5_JS_VER',  '241123');