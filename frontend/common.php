...
if (isset($_REQUEST['stx2']))  { // search text (검색어) //CONUT
...
// 일정 기간이 지난 DB 데이터 삭제 및 최적화 CONUT
//include_once(G5_BBS_PATH.'/db_table.optimize.php');

// common.php 파일을 수정할 필요가 없도록 확장합니다. CONUT
/*
$extend_file = array();
...
//CONUT 추가
$now_ymdhis_v = date('Y-m-d H:i:s', time());// 현재시간
//
