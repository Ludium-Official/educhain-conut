...
function get_board_sfl_select_options($sfl){ //CONUT 20230307

    global $is_admin;

    $str = '';
    $str .= '<option value="wr_6" '.get_selected($sfl, 'wr_6', true).'>상태</option>';
	$str .= '<option value="wr_subject" '.get_selected($sfl, 'wr_subject', true).'>문제</option>';
	$str .= '<option value="wr_3" '.get_selected($sfl, 'wr_3', true).'>정답</option>';
