...
//$mb_name        = isset($_POST['mb_name']) ? trim($_POST['mb_name']) : ''; //CONUT
$mb_name        = isset($_POST['mb_nick']) ? trim($_POST['mb_nick']) : '';
...
if ($w == '') {
    $sql = " insert into {$g5['member_table']}
                set mb_id = '{$mb_id}',
                     ...
                     mb_8 = '{$mb_8}',
                     mb_9 = '{$mb_9}',
                     mb_10 = 'OOOOOOOOOOOOOOOOO',
					 wepin_wallet = 'OOOOOOOOOOOOOOOOO'
                     {$sql_certify} ";
